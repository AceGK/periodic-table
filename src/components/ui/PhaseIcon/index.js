...
// Also map phase-key format (used by ElementCard/Legend)
const keyIconMap = {
...
export default function PhaseIcon({ phase, phaseKey, size = "1em" }) {
  const Icon = (phase && iconMap[phase]) || (phaseKey && keyIconMap[phaseKey]) || AiOutlineQuestionCircle;
  return <Icon size={size} />;
}

// Export individual icons for direct use (e.g. Legend)
export { IoIosCube as SolidIcon, TbDropletFilled as LiquidIcon, HeatIcon as GasIcon, AiOutlineQuestionCircle as UnknownIcon };
